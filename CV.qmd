...
::: {.entry}
<img class="entry-logo" src="https://www.siapgears.com/themes/siapgears2020/assets/images/favicons/apple-touch-icon.png" alt="SIAP logo">

::: {.entry-body}
[Internship, Quality Control department]{.entry-title}\
SIAP S.p.A. (Gruppo Carraro), IT - Precision measurements of mechanical components, sequential charts and control plans (SPC), CCP, and capability analysis (Cp, Cpk).\
[Jun - Sep 2017]{.entry-meta}
:::
:::

::: {.entry}
<img class="entry-logo" src="https://irp.cdn-website.com//ba83a6cf/dms3rep/multi/opt/Logo-480w.png" alt="De Nardo Alessandro Impianti Termoidraulici logo">

::: {.entry-body}
[Plumber apprentice]{.entry-title}\
De Nardo Alessandro Impianti Termoidraulici, IT - Summer apprenticeship, unrelated to my current career path but a formative experience.\
[Jun - Sep 2012, Jun - Sep 2013]{.entry-meta}
:::
:::
...
See the full list, including personal open-source work, on the [Projects](projects.qmd) page.
...
<img class="entry-logo" src="data/logos/unitn.svg" alt="University of Trento logo">
<img class="entry-logo" src="https://www.stellantis.com/favicon.ico" alt="Stellantis logo">
</div>
...
<div class="entry-logos">
<img class="entry-logo" src="data/logos/unitn.svg" alt="University of Trento logo">
<img class="entry-logo" src="https://www.aprilia.com/favicon.ico" alt="Aprilia Racing logo">
</div>
...
::: {.entry-body}
[Scientific High School Diploma]{.entry-title} - PNI curriculum (Piano Nazionale Informatica)\
Liceo Scientifico "Michelangelo Grigoletti"\
[2008 - 2013]{.entry-meta}
:::
:::
...
::: {.entry}
<img class="entry-logo" src="https://www.jsae.or.jp/en/img/common/logo-symbol.png" alt="JSAE logo">

::: {.entry-body}
[Best Paper Award Finalist]{.entry-title}\
AVEC 2026, Tsukuba, Japan - issued by the JSAE, one of the 10 papers selected as finalists, for *"Fast GGV Compliant Sampling-Based Planning for Vehicles"*\
[2026]{.entry-meta}
:::
:::

::: {.entry}
<img class="entry-logo" src="https://www.reply.com/favicon.ico" alt="Reply logo">
